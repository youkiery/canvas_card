    ...
    this.src.onload = () => {
      ...
      document.addEventListener("click", (e) => {        
        ...
        if(ck > -1) {
          ...
          this.draw.drawAllCard(this.ctx, this.src, this.card.fixed_deck, this.player, this.card.width, this.card.height, this.width, this.height)
        }
      })
    }
  }
